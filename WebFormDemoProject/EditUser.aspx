<%@ Page Language="C#" Title="Update User" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="WebFormDemoProject.EditUser" %>
                   ...
                   <div class="row mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-12  custom-tr">
                           ...
                           <%--<asp:Button ID="btnSave" runat="server" class="btn btn-primary  " Text="Update" style="width:200px"  OnClick="btnsubmit_Click" />--%>                           
                            <asp:Button ID="btnUpdate" runat="server" CssClass="btn btn-primary " OnClick="btnUpdate_Click" Text="Update" style="width:200px"/>
